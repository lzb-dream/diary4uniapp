<template>
	<image src="https://images.pexels.com/photos/941869/pexels-photo-941869.jpeg?auto=compress&cs=tinysrgb&w=1440" 
	 class="maxImage" mode="widthFix" @click="image"></image>

<!-- 	<text class="prompt">4K图片加载缓慢可尝试下载</text> -->
	<Loading></Loading>
	<view class="bottomMeta">
		<view class="setting" @click="setting">
			<uni-icons type="gear-filled" size="35" :color="settingColor"></uni-icons>
		</view>
		<view @click="heart">
			<uni-icons type="heart-filled" size="35" :color="heartColor"></uni-icons>
		</view>
		<view class="play" @click="download">
			<uni-icons type="download" size="35" :color="downloadColor"></uni-icons>
		</view>
		<view class="back" @click="back">
			<uni-icons type="back" size="35" :color="backColor"></uni-icons>
		</view>


		<view class="message">
			图片仅供学习，如有侵权请点击设置并反馈客服
		</view>
	</view>
